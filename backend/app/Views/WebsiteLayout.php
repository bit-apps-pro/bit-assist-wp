...
class WebsiteLayout
{
    ...
    public function head($currentScreen)
    {
        ...
        wp_enqueue_script($slug . '-widget-script-ASYNC-MODULE', $rootURL . '/iframe/bit-assist.js', [], $version, true);
        wp_localize_script($slug . '-widget-script-ASYNC-MODULE', Config::VAR_PREFIX, [
